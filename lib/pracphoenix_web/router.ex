defmodule PracphoenixWeb.Router do
  use PracphoenixWeb, :router
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {PracphoenixWeb.Layouts, :root}
  ...
  if Application.compile_env(:pracphoenix, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: PracphoenixWeb.Telemetry
