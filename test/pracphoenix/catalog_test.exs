defmodule Pracphoenix.CatalogTest do
  use Pracphoenix.DataCase

  alias Pracphoenix.Catalog

  describe "products" do
    alias Pracphoenix.Catalog.Product

    import Pracphoenix.CatalogFixtures
  ...
  describe "categories" do
    alias Pracphoenix.Catalog.Category
